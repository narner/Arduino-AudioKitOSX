...
- (nonnull instancetype)initWithNode:(AKNode * _Nonnull)node frame:(CGRect)frame callback:(void (^ _Nonnull)(double, double, double, double))callback OBJC_DESIGNATED_INITIALIZER;
